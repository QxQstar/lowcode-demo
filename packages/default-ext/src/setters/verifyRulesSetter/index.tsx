...
import type { SetterCommonProps, Rule } from 'vitis-lowcode-types'
...
function VerifyRulesSetter(props: Props) {
    ...
    return (
    <div>
        <div className='mt-2.5 p-2 bg-[#ebebeb] rounded-sm'>
            <Checkbox checked={!!requiredRule} onChange={checkRequired}>必填</Checkbox>
            {!!requiredRule && <div className='mt-2'>
